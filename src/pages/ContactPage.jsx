            ...
            {[
              {
                icon: Mail,
                label: "Email",
                value: "brijendratiwari993@gmail.com",
                href: "mailto:brijendratiwari993@gmail.com",
              },
              {
                icon: Phone,
                label: "Phone",
                value: "+91 86238 76761",
                href: "tel:+918623876761",
              },
              {
                icon: MapPin,
                label: "Location",
              ...
              <div key={label} className="card flex items-center gap-4">
                ...
                <div>
                  ...
                  {href ? (
                    <a
                      href={href}
                      className="text-white text-sm font-medium hover:text-gold-400 transition-colors"
                    >
                      {value}
                    </a>
                  ) : (
